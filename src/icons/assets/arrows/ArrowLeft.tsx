...
export const OutlineArrowLeft: React.FC<IconProps> = ({ className, size }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SolidArrowLeft: React.FC<IconProps> = ({ className, size }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DuotoneArrowLeft: React.FC<IconProps> = ({ className, size }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
