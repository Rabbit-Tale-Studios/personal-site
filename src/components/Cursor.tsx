...
const CursorComponent = ({ children }: { children: React.ReactNode }) => {
...
class Cursor {
  ...
  addListeners() {
    gsap.utils
      .toArray<HTMLElement>('[data-hover]')
      .forEach((hoverEl: HTMLElement) => {
        // set hover states
        {
          const hoverBoundsEl: HTMLElement = hoverEl.querySelector<HTMLElement>(
            '[data-hover-bounds]',
          )!
