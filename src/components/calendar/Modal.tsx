  ...
  return (
    props.open && (
      ...
      >
        <article
          className={cn(
            'group relative mx-2 my-2 max-h-screen w-full max-w-6xl overflow-hidden rounded-3xl bg-white-50 text-shark-800 shadow-xl shadow-shark-950/30 after:absolute after:left-0 after:top-0 after:h-full after:w-full after:rounded-3xl after:border-[6px] after:border-white-50/50',
            {
